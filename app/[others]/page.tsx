...
const NotFound = () => {
  return (
    <>
      <section className="relative z-10 flex min-h-[100vh] items-center justify-center bg-primary text-white lg:pt-20">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto mb-9 text-center">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#8F6E5D" stopOpacity="0" />
                        <stop offset="1" stopColor="#8F6E5D" />
                      </linearGradient>
                      <linearGradient
                ...
                <h3 className="mb-4 text-3xl font-bold text-white dark:text-white sm:text-4xl">
                ...
                <Link
                  href="/"
                  className="rounded-md border-2 border-white bg-primary px-8 py-3 text-base font-bold text-white shadow-signUp duration-300 hover:bg-white hover:text-primary md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Homepage
                </Link>
              </div>
